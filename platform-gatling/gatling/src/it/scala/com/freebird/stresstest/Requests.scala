...
object Requests {
  ...
  val firstItinerary =  Itinerary("UA", "6100", "2017-08-16T00:00:00Z", "ATL", "IAH", "", "", "")
  val secondItinerary = Itinerary("UA", "1061", "2017-08-16T00:00:00Z", "IAH", "MIA", "", "", "")
  ...
  val fifthItinerary = Itinerary("WN", "1557", "2017-08-16T00:00:00Z", "BOS", "ORD",  "2017-08-16T00:00:00Z", "ORD", "LAS")
  val sixthItinerary = Itinerary("WN", "1978", "2017-08-16T00:00:00Z", "LAS", "AUS", "2017-08-16T00:00:00Z", "AUS", "FLL")
  val seventhItinerary = Itinerary("WN", "6382", "2017-08-16T00:00:00Z", "LAX", "AUS", "2017-08-16T00:00:00Z", "AUS", "ATL")
  val eighthItinerary = Itinerary("WN", "148", "2017-08-16T00:00:00Z", "ATL", "DEN", "2017-08-16T00:00:00Z", "DEN", "SLC")
  ...
  val PURCHASE_REQUEST: String = """{"metadata":{"data":"abc"},"priceRequestId":"${priceRequestId}","priceTier":"GOLD","trip":{"id":"${tripId}","personInfo":[{"gender":"male","firstName":"GAURAV","lastName":"SHUKLA","middleName":"KUMAR","dateOfBirth":"1989-03-26","phone":"+918505847053","email":"nitin.aggarwal@knoldus.in","isPayer":true,"isPassenger":true,"notifyMe":true},{"gender":"male","firstName":"Celenox","lastName":"agent","middleName":"travel","dateOfBirth":"1989-03-26","phone":"+919990544491","email":"girish@knoldus.com","isPayer":false,"isPassenger":false,"notifyMe":false,"isTravelAgent":true}]},"pciTransactionId":"dsfsf34aswds"}"""
  ...
  val REBOOKING_SELECTION: String = """{"optionId": "${sameDayNonStopOptionsOptionId(1)}"}"""
